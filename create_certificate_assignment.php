...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="text" id="admin_id" name="admin_id"><br><br>
    ...
    if(isset($_POST['submit'])){
        ...
        function createCertificateAssignment($certificate_id, $admin_id, $event_id) {
            global $conn;
            
            $sql = "INSERT INTO certificate_assignments (certificate_id, admin_id, event_id)
                    VALUES ('$certificate_id', '$admin_id', '$event_id')";
        ...
        if (!empty($certificate_id) && !empty($admin_id) && !empty($event_id)) {
            createCertificateAssignment($certificate_id, $admin_id, $event_id);
        }
